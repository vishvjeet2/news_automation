...
<div class="container">
    <!-- Background Image -->
    <img src="<?php echo e($template); ?>" class="background" alt="background">
    ...
    <!-- Content Overlay -->
    <div class="content <?php echo e(empty($data) ? 'no-description' : ''); ?>">

        <div class="heading <?php echo e(empty($data) ? 'full-heading' : ''); ?>">
            <?php echo e($heading); ?>
...
</html><?php /**PATH C:\Users\Gumnaami BaBa\Desktop\news_automation\resources\views/news/newstext.blade.php ENDPATH**/ ?>